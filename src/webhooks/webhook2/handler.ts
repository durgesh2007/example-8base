 ...
 *    8base invoke-local webhook2 -p src/resolvers/webhook2/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local webhook2 -m request
 *
 ...
 *    8base generate mock webhook2 -m [MOCK_FILE_NAME]
 */
